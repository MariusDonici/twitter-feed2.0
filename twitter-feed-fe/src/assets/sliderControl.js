        ...
        $("#leaflet-slider").slider({
            ...
            slide: function (e, ui) {
                ...
                if(!!_options.markers[ui.value]) {
                    ...
                    if(_options.markers[ui.value].tweet !== undefined) {
                        if(_options.markers[ui.value].tweet.createdAt){
                            if(_options.markers[ui.value]) $('#slider-timestamp').html(
                                _extractTimestamp(_options.markers[ui.value].tweet.createdAt, _options));
                        }else {
